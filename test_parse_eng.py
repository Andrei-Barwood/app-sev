...
df_upload = pd.read_csv("test.csv", sep=r'[;\t]', engine='python')
if df_upload.shape[1] < 2:
    print("Fallo 1: shape < 2")
    df_upload = pd.read_csv("test.csv", sep=None, engine='python')

print("Columns:", df_upload.columns)
